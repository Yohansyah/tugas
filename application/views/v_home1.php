...
<link rel="stylesheet" type="text/css" href="cere/styles/bootstrap4/bootstrap.min.css">
<link href="cere/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="cere/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="cere/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="cere/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="cere/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="cere/styles/responsive.css">
</head>
<body>
...
<div class="super_container">
							...
							<a href="#">
								<div class="logo_content d-flex flex-column align-items-start justify-content-center">
									...
									<div class="logo d-flex flex-row align-items-center justify-content-center">
										<div class="logo_text">YOIKI<span>HANS</span></div>
    ...
    <div class="about_image"><img src="cere/images/home_background_1.jpg" alt=""></div>
			<!-- Home Slider -->
			<div class="owl-carousel owl-theme home_slider">
				
				<!-- Slider Item -->
				<div class="owl-item">
					<div style="background-image:url(cere/images/home_background_1.jpg)"></div>
				...
				<!-- Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(cere/images/home_background_1.jpg)"></div>
					<div class="home_content">
						<div class="container">
							<div class="row">
								<div class="col">
			...
			<div class="row">
				...
				<div class="col-lg-4 box_col">
					<div class="box working_hours">
						<div class="box_icon d-flex flex-column align-items-start justify-content-center"><div style="width:29px; height:29px;"><img src="cere/images/alarm-clock.svg" alt=""></div></div>
				...
				<div class="col-lg-4 box_col">
					<div class="box box_appointments">
						<div class="box_icon d-flex flex-column align-items-start justify-content-center"><div style="width: 29px; height:29px;"><img src="cere/images/phone-call.svg" alt=""></div></div>
				...
				<div class="col-lg-4 box_col">
					<div class="box box_emergency">
						<div class="box_icon d-flex flex-column align-items-start justify-content-center"><div style="width: 37px; height:37px; margin-left:-4px;"><img src="cere/images/bell.svg" alt=""></div></div>
	...
	<div class="about">
		<div class="container">
			<div class="row row-lg-eq-height">
				...
				<!-- About Image -->
				<div class="col-lg-5">
					<div class="about_image"><img src="cere/images/about.png" alt=""></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="departments">
		<div class="departments_background parallax-window" data-parallax="scroll" data-image-src="cere/images/departments.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row departments_row row-md-eq-height">
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						<div class="dept_image"><img src="cere/images/dept_1.jpg" alt=""></div>
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						<div class="dept_image"><img src="cere/images/dept_2.jpg" alt=""></div>
						<div class="dept_content text-center">
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						<div class="dept_image"><img src="cere/images/dept_3.jpg" alt=""></div>
						<div class="dept_content text-center">
		...
		<div class="container">
			...
			<div class="row services_row">
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="cere/images/service_1.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="cere/images/service_2.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="cere/images/service_3.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="cere/images/service_4.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="cere/images/service_6.svg" alt=""></div>
	...
	<div class="cta">
		<div class="cta_background parallax-window" data-parallax="scroll" data-image-src="cere/images/cta.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
							...
							<ul class="footer_about_list">
								<li><div class="footer_about_icon"><img src="cere/images/phone-call.svg" alt=""></div><span>+45 677 8993000 223</span></li>
								<li><div class="footer_about_icon"><img src="cere/images/envelope.svg" alt=""></div><span>office@template.com</span></li>
								<li><div class="footer_about_icon"><img src="cere/images/placeholder.svg" alt=""></div><span>Main Str. no 45-46, b3, 56832, Los Angeles, CA</span></li>
							</ul>
						</div>
					</div>
